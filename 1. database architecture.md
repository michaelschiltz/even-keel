...
*note that the `amount of interest bills (e)` were categorized differently, for reasons explained below.*

Table 1.

| bill type    | specifics             | amounts | calculations (including addition of 'interest bills' data)                                                   |
|--------------|-----------------------|---------|-----------------------------------------------------------------|
