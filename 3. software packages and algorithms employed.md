...
> * This technique is especially helpful because of a caveat in contemporary Social Network Anlysis, i.e. the difficulty to conceive of *negative flows*. Admittedly, there seems to have been [some improvement in this respect](https://doi.org/10.1016/j.socnet.2014.03.005), but this is still a far cry from applications in, for instance, finance, where negative flows (for example: somebody initiating a negative flow by overdrawing his/her account) are very common.
